...
export default function IfMobile(){
    ...
    return(
        <>        
            {mobile && (
                <div style={{ position: "fixed", display: "flex", justifyContent:"center", alignItems:"center", gap: "1rem", flexDirection:"column", color: "var(--color)", width: "100%", height: "100%", backgroundColor: "beige", zIndex:"999"}}>
                    <p>PC에서 감상해주세요</p>
                </div> 
            )}
        </>
