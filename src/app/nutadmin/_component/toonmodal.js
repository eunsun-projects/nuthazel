...
export default function ToonModal({setModal, data, currNum, setToonList}){
    ...
    const handleSort = (e) =>{
        e.preventDefault();
        if(confirm('정렬하시겠습니까? 파일명은 이름+숫자.확장자로 맞추어주세요. ex) name1.jpg혹은 name1.png')){
            if(imgFiles){
                const copy = [...imgFiles]
            ...
            <div className={styles.toonmodalpage}>
                ...
                <form ref={formRef} encType="multipart/form-data" className={styles.toonform} onSubmit={handleSubmit}>
                    ...
                    <div style={{display: "flex", flexDirection: "column"}}>
                        ...
                        <button className={styles.alignbtn} onClick={handleSort}>정렬</button>
                    </div>
